...
class TeamMember(db.Model):
    ...
    aligned_rep_3 = db.Column(db.String(100))
    aligned_rep_4 = db.Column(db.String(100))
    location = db.Column(db.String(100))
    aligned_rep_location = db.Column(db.String(100))
    aligned_rep_2_location = db.Column(db.String(100))
